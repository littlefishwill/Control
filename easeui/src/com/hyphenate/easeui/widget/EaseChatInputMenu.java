...
//        primaryMenuContainer.setVisibility(View.GONE);
     ...
     * @param emojiconGroupList --will use default if null
     */
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList,boolean isTestnumber) {
        if(inited){
            return;
        }
        // primary menu, use default if no customized one
...
//        primaryMenuContainer.setVisibility(View.GONE);
        ...
        processChatMenu();
        chatExtendMenu.init();
        chatExtendMenu.isTestNumber(isTestnumber);
     ...
     */
    public void registerExtendMenuItem(String name, String drawableRes, int itemId,boolean lock,double price,
            EaseChatExtendMenuItemClickListener listener) {
        chatExtendMenu.registerMenuItem(name, drawableRes, itemId,lock,price,listener);
    }
     ...
     *            on click event of item
     */
    public void registerExtendMenuItem(int nameRes, String drawableRes, int itemId,boolean lock,double price,
            EaseChatExtendMenuItemClickListener listener) {
        chatExtendMenu.registerMenuItem(nameRes, drawableRes, itemId,lock,price, listener);
    }
