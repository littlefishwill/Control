...
public class CameraHelperActionTool implements PreviewCallback {
    ...
    public CameraHelperActionTool(EMCallManager.EMVideoCallHelper callHelper) {
...
//            EMCallManager.EMVideoCallHelper.getInstance().setResolution(mwidth, mheight);
...
//                    callHelper.processPreviewData(mheight, mwidth, yuv_Rotate90);
    ...
    boolean isScreenOriatationPortrait() {
        return ControlApplication.context.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
