...
public class BaiduLocationTool {
	...
	public static BaiduLocationTool getInstace() {
	...
	public void init(Context context) {
		...
		mLocationClient.registerLocationListener(new BDLocationListener() {
			...
			public void onReceiveLocation(BDLocation arg0) {
				// TODO Auto-generated method stub
				for(LocationCallBack loc:locCallBacks){
					loc.onSuccess(arg0);
				}
				locCallBacks.clear();
	...
	public void getLocation(LocationCallBack locationCallBack){
		locCallBacks.add(locationCallBack);
		mLocationClient.start();
	}

	private List<LocationCallBack> locCallBacks = new ArrayList<LocationCallBack>();
