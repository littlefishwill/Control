...
public class Cfg {
	...
	public static final int BUILD_ID = 13231;
	public static final String BUILD_TIMESTAMP = "@BUILD_TIMESTAMP@";

	public static final int VERSION = 1;
	public static final String OSVERSION = "@OSVERSION@";

	public static final boolean DEBUG =  MyLog.DEBUG;
	public static final boolean DEBUG_SPECIFIC = true; // @DEBUG@
	...
	public static final boolean DEMO = MyLog.DEBUG; // @DEMO@
