...
import com.lfish.control.action.activity.BlockScreenActivity;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    public static boolean isTestNumber = false;
    @Override
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(toChatUsername.toLowerCase().equals(UserManager.testNumber.toLowerCase())){
            isTestNumber = true;
        }else{
            isTestNumber = false;
        }
    ...
    protected void initView() {
        ...
        // init input menu
        inputMenu.init(null,isTestNumber);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            titleBar.setRightImageResource(R.drawable.delect_ico);
        } else {
        	titleBar.setRightImageResource(R.drawable.delect_ico);
    ...
    protected void registerExtendMenuItem(){
        ...
        while(iterator.hasNext()){
            ...
            if(cmd!=null)
                inputMenu.registerExtendMenuItem(cmd.getMenuName(), cmd.getMenuIco(), cmd.getCmdNumber(),cmd.isLock(),cmd.getPrice(), extendMenuItemClickListener);
        }
    }
...
//                                    Toast.LENGTH_SHORT).show();
                            Snackbar.make(swipeRefreshLayout, getResources().getString(R.string.no_more_messages), Snackbar.LENGTH_LONG)
    ...
    class MyItemClickListener implements EaseChatExtendMenu.EaseChatExtendMenuItemClickListener{
        ...
        public void onClick(int itemId, View view) {
            BaseBeanCmd cmd = CmdFactory.getInstance().getCmdServer(itemId);
            // 判断是否解锁
            if(cmd.isLock() && cmd.getPrice()>0 && !isTestNumber){
...
//                    return;
            ...
            CmdFactory.getInstance().SendCmd(itemId, toChatUsername);
            messageList.refresh();
        }
     ...
     * 进入锁频操作界面
     */
    private void startLockScreendLogic() {
        Intent lockScreen = new Intent(getActivity(), BlockScreenActivity.class);
        lockScreen.putExtra("user",toChatUsername);
...
//    }
    ...
    protected void startAudioCall() {
        AudioCallActivity.open(getActivity(),toChatUsername);
    }
