...
public class HoverImageView extends ImageView{
	...
	private void setup(AttributeSet attrs) {
		if(attrs != null){
			...
			borderColor = typedArray.getColor(R.styleable.RoundImageView_riv_borderColor, borderColor);
			hoverColor = typedArray.getColor(R.styleable.RoundImageView_riv_hoverColor, hoverColor);
			borderWidth = typedArray.getDimension(R.styleable.RoundImageView_riv_borderWidth, borderWidth);
			typedArray.recycle();
		}
